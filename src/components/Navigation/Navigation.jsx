...
const Navigation = ( {sticky} ) => {
  return (
    <nav
    className={`${sticky ? 'lg:bg-[#212EA0] transition-all delay-100 ' :''}fixed lg:w-full lg:h-22 lg:flex-row z-10 flex lg:items-center lg:justify-evenly py-3 w-[40vw] flex-col right-0  h-screen gap-10 items-center pt-10`}
    >
        <div className="logo">
            <img 
            className='w-[180px]'
